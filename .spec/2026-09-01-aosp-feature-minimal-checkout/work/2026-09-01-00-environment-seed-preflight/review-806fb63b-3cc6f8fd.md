# review 包 806fb63b..3cc6f8fd

## commit 列表

```
3cc6f8f feat(spec): add supersession accept mode
```

## diff --stat

```
 .../work/modes/accept.py                           | 183 +++++++++++++++++++++
...
+    owned = sorted(set(paths) | {str(pathlib.PurePosixPath(p).parent) for p in paths})
