# review 包 770fc1ff..8d2a1f48

## commit 列表

```
8d2a1f4 fix: harden resolver lock handling
...
```
 .../closure/v1/lib/seed_contract_runtime.py        | 63 +++++++++++++++++++++-
...
@@ -170,20 +170,81 @@ def load_artifact(*, path: str, expected_kind: str) -> dict:
