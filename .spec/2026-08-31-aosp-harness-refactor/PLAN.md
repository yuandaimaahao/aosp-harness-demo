...
| `05a-verifier-contract-assurance` | 在任何runtime/adapter消费者前穷举verifier grammar、CLI、argv与失败矩阵 | `05-verifier-contract` | dependency-present时`./tests/test-verifier-contract-assurance.sh`输出`RESULT PASS  verifier contract assurance`且完整manifest全PASS | ⏳ 进行中 |
