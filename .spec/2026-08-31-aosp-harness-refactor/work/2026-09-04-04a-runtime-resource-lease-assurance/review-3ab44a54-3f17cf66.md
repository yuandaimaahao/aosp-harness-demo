# review 包 3ab44a54..3f17cf66

## commit 列表

```
3f17cf6 test: add resource lease assurance
```

## diff --stat

```
 tests/test-resource-leases-assurance.sh | 396 ++++++++++++++++++++++++++++++++
...
```diff
diff --git a/tests/test-resource-leases-assurance.sh b/tests/test-resource-leases-assurance.sh
new file mode 100755
index 0000000..c626d54
--- /dev/null
+++ b/tests/test-resource-leases-assurance.sh
@@ -0,0 +1,396 @@
+#!/usr/bin/env bash
