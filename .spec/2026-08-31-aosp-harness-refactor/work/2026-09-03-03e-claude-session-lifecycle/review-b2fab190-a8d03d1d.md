# review 包 b2fab190..a8d03d1d

## commit 列表

```
a8d03d1 refactor(claude): confine demo writes to private mktemp tree
```

## diff --stat

```
 claude-code/run-demo.sh | 51 +++++++++++++++++++++++++++++++++++--------------
...
```diff
diff --git a/claude-code/run-demo.sh b/claude-code/run-demo.sh
index 86e30c7..71c4f85 100755
--- a/claude-code/run-demo.sh
+++ b/claude-code/run-demo.sh
@@ -3,50 +3,73 @@
 #
