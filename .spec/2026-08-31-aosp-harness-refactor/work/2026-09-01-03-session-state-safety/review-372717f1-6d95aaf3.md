# review 包 372717f1..6d95aaf3

## commit 列表

```
6d95aaf test(session): isolate state root fixtures
```

## diff --stat

```
 tests/test-session-state.sh | 162 ++++++++++++++++++++++++++++++++++----------
...
+  fi
 ...
 capture_api() {
   ...
   API_RC=$?
@@ -81,83 +116,140 @@ cmp -s "$SOURCE_FIXTURE/sentinel" "$SOURCE_SENTINEL_EXPECTED" || fail 'source da
