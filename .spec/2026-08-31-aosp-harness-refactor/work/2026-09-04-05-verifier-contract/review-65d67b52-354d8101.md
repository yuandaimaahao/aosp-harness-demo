# review 包 65d67b52..354d8101

## commit 列表

```
354d810 test(harness): add verifier base contract
```

## diff --stat

```
 tests/test-verifier-contract.sh | 102 ++++++++++++++++++++++++++++++++++++++++
...
```diff
diff --git a/tests/test-verifier-contract.sh b/tests/test-verifier-contract.sh
new file mode 100755
index 0000000..f15bb33
--- /dev/null
+++ b/tests/test-verifier-contract.sh
@@ -0,0 +1,102 @@
+#!/usr/bin/env bash
+set -uo pipefail
