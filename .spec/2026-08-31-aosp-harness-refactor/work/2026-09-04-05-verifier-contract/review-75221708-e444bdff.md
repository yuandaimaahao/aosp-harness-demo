# review 包 75221708..e444bdff

## commit 列表

```
e444bdf docs(harness): define verifier contract
```

## diff --stat

```
 docs/verifier-contract.md | 67 +++++++++++++++++++++++++++++++++++++++++++++++
...
```diff
diff --git a/docs/verifier-contract.md b/docs/verifier-contract.md
new file mode 100644
index 0000000..de4cea1
--- /dev/null
+++ b/docs/verifier-contract.md
@@ -0,0 +1,67 @@
