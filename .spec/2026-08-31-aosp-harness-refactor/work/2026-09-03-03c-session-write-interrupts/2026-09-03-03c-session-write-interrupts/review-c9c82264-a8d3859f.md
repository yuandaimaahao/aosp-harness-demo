# review 包 c9c82264..a8d3859f

## commit 列表

```
a8d3859 feat(session): add write signal-forwarding facade
```

## diff --stat

```
 common/.harness/lib/session-state-signals.sh | 45 ++++++++++++++++++++++++++++
...
```diff
diff --git a/common/.harness/lib/session-state-signals.sh b/common/.harness/lib/session-state-signals.sh
new file mode 100644
index 0000000..89961a5
--- /dev/null
+++ b/common/.harness/lib/session-state-signals.sh
@@ -0,0 +1,45 @@
+#!/usr/bin/env bash
