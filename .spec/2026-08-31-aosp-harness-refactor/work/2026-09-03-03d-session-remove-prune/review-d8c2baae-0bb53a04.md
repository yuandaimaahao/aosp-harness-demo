# review 包 d8c2baae..0bb53a04

## commit 列表

```
0bb53a0 feat(session): add non-creating verified remove module
```

## diff --stat

```
 common/.harness/lib/session-state-remove.sh | 110 ++++++++++++++++++++++++++++
...
```diff
diff --git a/common/.harness/lib/session-state-remove.sh b/common/.harness/lib/session-state-remove.sh
new file mode 100644
index 0000000..e8c7aed
--- /dev/null
+++ b/common/.harness/lib/session-state-remove.sh
@@ -0,0 +1,110 @@
+#!/usr/bin/env bash
