# review 包 7c0d1b12..c7ef909b

## commit 列表

```
c7ef909 test(quality): strengthen offline core contract
```

## diff --stat

```
 tests/test-quality-gate.sh | 23 +++++++++++++++--------
...
index edc704f..4fed341 100755
--- a/tests/test-quality-gate.sh
+++ b/tests/test-quality-gate.sh
@@ -5,49 +5,56 @@ repo_root="$(cd -- "${BASH_SOURCE[0]%/*}/.." && pwd -P)"; host_bash="$(command -
