# review 包 6b6f7492..7c0d1b12

## commit 列表

```
7c0d1b1 feat(quality): run offline core checks
```
...
index 03ba5a8..a08408d 100755
--- a/scripts/check.sh
+++ b/scripts/check.sh
@@ -6,11 +6,26 @@ quality_protocol_error() {
 }
 [[ "$#" -eq 1 && ( "$1" == --offline || "$1" == --ci ) ]] ||
